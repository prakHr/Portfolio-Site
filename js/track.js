        ...
        Mmodel.detect(Mvideo).then(Mpredictions => {
            ...
            if (Mpredictions.length > 0) {
                ...
                if (label == 'closed') {
                    ...
                    window.scrollBy(0, -1000); // The second parameter is the vertical scroll distance (negative value for upward scroll)
                } else if (label == 'open') {
                    // Scroll a little bit down (e.g., 100 pixels)
                    window.scrollBy(0, 1000); // The second parameter is the vertical scroll distance (positive value for downward scroll)
                }
            }
